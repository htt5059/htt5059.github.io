            ...
            <div className="h-full my-5 mx-2 flex flex-col items-scretch">
                ...
                <div className="h-full flex flex-col items-scretch">
                    <form className="w-full h-full" onSubmit={submitHandler}>
                        <input onChange={(e) => setEmail(e.target.value)} name="email" type="email" className="w-full my-2 p-2 ps-5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Email" required/>
